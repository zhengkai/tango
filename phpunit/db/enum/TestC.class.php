...
class TestC extends Tango\Drive\DBEnumBase {

	use enumDebug;

	static protected $_sDB = 'test';
	static protected $_sDBTable = 'enum_test_c';

	static protected $_sKeyID = 'id';
	static protected $_lKeySearch = ['row_a'];

	static protected $_sKeyHash = 'hash_a';
	static protected $_sHashAlgo = 'sha1';
